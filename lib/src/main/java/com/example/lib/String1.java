...
public class String1 {
     ...
     * str.substring(i, j) to extract the String starting at index i and going up to but not
     * including index j.
     *
     * makeOutWord("<<>>", "Yay") → "<<Yay>>"
     ...
     * string without the substring at the beginning, so "HelloHe" yields "lloHe".
     * The substring may overlap with itself, so "Hi" yields "". Otherwise, return
     ...
     * those 'x' chars, and otherwise return the string unchanged. This is a little
     * harder than it looks.
     *
     * withoutX2("xHi") → "Hi"
     * withoutX2("Hxi") → "Hi"
