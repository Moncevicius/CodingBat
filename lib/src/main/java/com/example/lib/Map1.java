...
public class Map1 {
     ...
     * mapShare({"a": "aaa", "c": "meh", "d": "hi"}) â†’ {"a": "aaa", "b": "aaa", "d": "hi"}
     */
     ...
     * <p>
     * topping1({"ice cream": "peanuts"}) â†’ {"bread": "butter", "ice cream": "cherry"}
     * topping1({}) â†’ {"bread": "butter"}
     * topping1({"pancake": "syrup"}) â†’ {"bread": "butter", "pancake": "syrup"}
     */
     ...
     * topping2({"spinach": "dirt", "ice cream": "cherry"}) â†’ {"yogurt": "cherry", "spinach": "nuts", "ice cream": "cherry"}
     ...
     * topping3({"salad": "oil", "potato": "ketchup"}) â†’ {"spinach": "oil", "salad": "oil",
     ...
     * mapAB3({"b": "bbb", "c": "cake"}) â†’ {"a": "bbb", "b": "bbb", "c": "cake"}
